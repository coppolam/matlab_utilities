function [Q, rl, reward, n_steps, sum_happy ] = rl_episode (rl, state_global, Q, varargin)
...
find_deadlocks  = checkifparameterpresent(varargin,'find_deadlocks',1,'array');
